fetch("https://api.github.com/repos/navycut/navycut").then(res=>res.json()).then(repo=>{
...
fetch("https://api.github.com/repos/navycut/navycut/contributors?per_page=1&anon=true")
