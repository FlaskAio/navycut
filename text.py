# # def name(*wargs, **kwargs):
# #     print (wargs)
# #     print (kwargs)

# # name({"name":"aniket"}, name="aniket")
...
# # print (nob.name)
# nob.details.update(country="babin")
# # # print (nob.name)
# # print (nob.details.country)
# # # print (nob.details)
# # # print (dir(nob))
# # d = nob.__dict__
# # d.pop('dict')
...
password = getpass(prompt="enter admin password here: ")
